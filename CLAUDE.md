...
- Los textos hablan de lo que el cliente obtiene, no de con qué lo hacemos: no se nombran herramientas internas (n8n, Medusa, NocoDB, Railway, Resend, Cloudflare…) en páginas, títulos, descripciones, JSON-LD, menús ni pie. Sí van los sellos que el cliente reconoce (Meta, WhatsApp Business, Google, Instagram) y las comparaciones con plataformas conocidas. La única excepción es la política de privacidad, donde sí se nombran los encargados del tratamiento.

...
const RESPALDO: Pick<Servicio, 'id' | 'nombre' | 'descripcion' | 'duracionMin' | 'lugar'>[] = [
  ...
  { id: 'demostracion-de-la-plataforma', nombre: 'Demostración de la plataforma', descripcion: 'Te mostramos en vivo la plataforma de Soulbyte: WhatsApp Business, tienda, catálogo en Google y las automatizaciones de agenda, cobros y redes.', duracionMin: 45, lugar: 'Videollamada' },
];

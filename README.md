...
| Ruta | Qué es |
|---|---|
| `index.html` | Presentación de Soulbyte como proveedor tecnológico de e-commerce. Acreditaciones: Tech Provider de WhatsApp Business (App Review aprobado el 12-sep-2026, app "Soulbyte n8n" 1781576016329423, empresa Soulbyte S.A.S. 576096632544762 verificada) y cuenta avanzada de Google Merchant Center (aprobada el 3-sep-2026, cuenta principal 5847345525; subcuentas Hit-Air Colombia 5848128866 y Ekivibes 5847731944). |
